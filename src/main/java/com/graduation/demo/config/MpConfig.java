...
public class MpConfig {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig
                .setUrl("jdbc:mysql://127.0.0.1:3306/graduate?userSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC")
        ...
        strategyConfig
                ...
                .setInclude("xk_teach_course")// 设置要映射的表
                .setTablePrefix("xk_")// 去掉表前缀
